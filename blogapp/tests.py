...
class ArticleViewsTest(TestCase):
    ...
    def test_article_create_view_authenticated_user(self):
        response = self.client.post(reverse('blogapp:article_add'),
                                    {'title': 'New test Article', 'content': 'New article text'})
    ...
    def test_article_update_view_authenticated_user(self):
        ...
        response = self.client.post(reverse('blogapp:article_update', args=[self.article.pk]),
    ...
    def test_article_delete_view_authenticated_user(self):
        ...
        with self.assertRaises(Article.DoesNotExist):
            deleted_article = Article.objects.get(pk=self.article.pk)
    ...
    def test_article_create_view_unauthenticated_user(self):
        ...
        with self.assertRaises(Article.DoesNotExist):
            new_post = Article.objects.get(title='New Post')
